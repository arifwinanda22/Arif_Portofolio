...
// // ixmport portfolio2 from '../assets/image.png'
...
// src/data/dataPortfolio.jsx

import portfolio1 from '../assets/portfolio1.png'
// import portfolio2 from '../assets/image.png'
import figmaPort1 from '../assets/gambar_figma_satu.png'
import figmaPort3 from '../assets/gambar_figma_tiga.png'
import portfolio3 from '../assets/android.png'
import androidPortfolio from '../assets/androidPortfolio.png'
import figmaPortfolio from '../assets/figma.png'
import laravelPortfolio from '../assets/laravel.png'
...
export const portfolioList = [
    {
        id:'1',
        title:'SmartComp: Competition & Workshop Platform',
        thumbnail:laravelPortfolio,
        detailImage:webPorto,
        skill: 'ReactJS, HTML, CSS, Express, PHP, Laravel, MySQL, Git, GitHub',
        desc: 'A comprehensive web-based platform designed to help students and professionals discover competitions and workshops. Features include user authentication, a skill management system to track personal growth, and a dynamic dashboard for event organizers to manage listings efficiently.'
    },
     {
        id:'2',
        title: 'UI/UX Design: SmartComp & Mobile JKN Redesign',
        thumbnail:figmaPortfolio,
        detailImage:portfolioUIUX,
        detailImage2:figmaPort1,
        detailImage3:figmaPort3,
        skill: 'Figma, Web Design, UI/UX Design, Wireframing, Prototyping',
        desc: 'A comprehensive UI/UX showcase featuring two distinct approaches: product creation and experience optimization. This project includes the end-to-end design of the SmartComp mobile ecosystem and a strategic redesign of the Mobile JKN application. The redesign process was driven by deep UX analysis and rigorous usability testing with real users to identify pain points and validate the improved interface.'
    },
     {
        id:'3',
        title: 'My Android Mobile Smartcomp Project #3',
        ...
        detailImage:androidPortfolio,
        skill:'Flutter, Firebase Firestore Database, GIT, GitHub, Mobile App Development, UI/UX Design, Dart Programming Language',
        desc: 'A mobile application developed using Flutter and Firebase, designed to facilitate competition and workshop discovery for students and professionals. The app features user authentication, a skill management system, and a dynamic dashboard for event organizers to efficiently manage their listings.'
    },
     {
        id:'4',
        title: 'My Java Web Application Project',
        thumbnail:portfolio4,
        detailImage:portfolio4,
        skill:'Java, Apache Tomcat, OOP, Jakarta EE, Spring Framework, SQL, JDBC, JPA',
        desc: 'A web-based application developed using Java Enterprise Edition (Java EE) technologies. This project implements the Model-View-Controller (MVC) architecture and utilizes Apache Tomcat server for deployment. Key features include CRUD operations, secure database connectivity using JDBC/JPA, and object-oriented design principles.'
    },
     {
        id:'5',
        title: 'IoT Project with ESP32 and MQTT Protocol',
        ...
        detailImage2:mqttApp,
        skill:'C++, ESP32, MQTT Protocol, Mobile App Development, IoT Systems',
        desc: 'This project involves the development of an IoT system using ESP32 microcontrollers and the MQTT protocol for efficient communication. The system includes sensor data collection, real-time monitoring, and control functionalities through a dedicated mobile application. The project demonstrates the integration of hardware and software components to create a seamless IoT experience.' 
    },
    {
        id:'6',
        title: 'Melanoma Detection Research using ReXNet-150',
        ...
        detailImage: portofolioResearch,
        skill: 'Python, PyTorch, ReXNet-150, Grad-CAM, Academic Writing, Scientific Research, Data Analysis',
        desc: 'Conducted rigorous research on Melanoma Skin Cancer classification utilizing the ReXNet-150 Deep Learning architecture. The study integrated Explainable AI (Grad-CAM) to enhance diagnostic transparency. This project culminated in the authorship of a scientific paper, documenting the methodology, experimental results, and contributions to efficient Computer-Aided Diagnosis (CAD) systems.'
    },
    {
        id: '7',
        title: 'Sanditel: Asset Management & Employee Reporting System', 
        ...
        detailImage: portofolioSanditel, 
        skill: 'ReactJS, Laravel, PHP, MySQL/PostgreSQL, REST API, Docker, Git, GitHub',
        desc: 'Developed a comprehensive internal management system for the Telecommunications Section of the West Java Provincial Secretariat (Sanditel Sekda Jabar). This platform integrates two core modules: an Inventory Management System for tracking state assets and logistics, and a Daily Employee Reporting System (Laporan Harian) to monitor staff productivity. Key features include real-time asset tracking, automated report generation, and role-based dashboards for efficient bureaucratic administration.',
        demoLink: 'https://fe-sanditel-blush.vercel.app/',    
    }
]